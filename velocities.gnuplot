...
# set terminal png truecolor nocrop font "arial,12" fontscale 1.0 size 640,480 
# set output 'vxvy.png'
unset clip points
set clip one
unset clip two
...
set title "Compared Velocities for a Satellite's Orbit Around Earth" 
...
GNUTERM = "wxt"
plot "satellite.txt" using 4:5 with lines
#    EOF
